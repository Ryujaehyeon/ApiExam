...
// MFCExamView.cpp: CMFCExamView 클래스의 구현
//
...
void CMFCExamView::OnDraw(CDC* pDC)
{
	...
	pDC->TextOutW(10, 10, TEXT("MFC로 만든 예제입니다."));
}
...
CMFCExamDoc* CMFCExamView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
