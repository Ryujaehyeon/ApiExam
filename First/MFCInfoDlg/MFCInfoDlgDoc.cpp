...
// MFCInfoDlgDoc.cpp: CMFCInfoDlgDoc 클래스의 구현
//
...
// CMFCInfoDlgDoc 생성/소멸

CMFCInfoDlgDoc::CMFCInfoDlgDoc() noexcept
	:m_x(100), m_y(100), m_str(TEXT("String")) // 초기화
{
...
// 축소판 그림을 지원합니다.
void CMFCInfoDlgDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCInfoDlgDoc::InitializeSearchContent()
{
...
void CMFCInfoDlgDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
