...
// MFCKeyDoc.cpp: CMFCKeyDoc 클래스의 구현
//
...
CMFCKeyDoc::CMFCKeyDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMFCKeyDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCKeyDoc::InitializeSearchContent()
{
...
void CMFCKeyDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
