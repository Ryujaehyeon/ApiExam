...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        r4 = CreateWindow(TEXT("button"), TEXT("Black"), WS_CHILD | WS_VISIBLE |
            BS_AUTORADIOBUTTON | WS_GROUP,
            150, 20, 100, 30, hWnd, (HMENU)eRadio::ID_R4, g_hInst, NULL);
        r5 = CreateWindow(TEXT("button"), TEXT("Red"), WS_CHILD | WS_VISIBLE |
            BS_AUTORADIOBUTTON,
            150, 50, 100, 30, hWnd, (HMENU)eRadio::ID_R5, g_hInst, NULL);
        r6 = CreateWindow(TEXT("button"), TEXT("Blue"), WS_CHILD | WS_VISIBLE |
            BS_AUTORADIOBUTTON,
            150, 80, 100, 30, hWnd, (HMENU)eRadio::ID_R6, g_hInst, NULL);
        CheckRadioButton(hWnd, (int)eRadio::ID_R1, (int)eRadio::ID_R3, (int)eRadio::ID_R1);
        CheckRadioButton(hWnd, (int)eRadio::ID_R4, (int)eRadio::ID_R6, (int)eRadio::ID_R4);
        break;
    case WM_COMMAND:
        switch (LOWORD(wParam)) {
        case (int)eRadio::ID_R1:
            Graph = 0;
            break;
        case (int)eRadio::ID_R2:
            Graph = 1;
            break;
        case (int)eRadio::ID_R3:
            Graph = 2;
            break;
